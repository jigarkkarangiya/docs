...
//repo : https://github.com/jigarkkarangiya/docs.git

const organizationName = "jigarkkarangiya"; // Usually your GitHub org/user name.
...
const config: Config = {
  ...
  url: 'https://docs.jigarkarangiya.com',
